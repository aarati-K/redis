...
# Phase 2: ETC workload - Generate total 100M requests
...
num_set_requests = num_requests_to_generate/31 # 3.226 million
...
# We will have 200 iterations of approx 0.5 million requests each
num_iterations = 200
